...
class ASTModel(nn.Module):
    def __init__(self, label_dim=527,
        ...
        # use a pretrained models for finetuning
            ...
            # audio_model.load_state_dict(sd, strict=False) # uncomment this line if you want to load the whole models
    ...
    def forward(self, x, task, cluster=True, mask_patch=400):
        # expect input x = (batch_size, time_frame_num, frequency_bins), e.g., (12, 512, 128)
        x = x.unsqueeze(1)
        x = x.transpose(2, 3)
